...
**Description:**
Developed a modular inventory management system using Python and SQLite to manage book and author data.
...
**Tech Stack:**
Python, SQLite, SQL, Relational Database Design

**How to Run:**
1. Clone the repository
2. Run main.py in Python3
3. Ensure SQLite database is in the same folder
